...
void KARModPackManager::CreateWidgets()
{
...
void KARModPackManager::ConnectWidgets()
{
  connect(m_open_directory_button, &QPushButton::clicked, this,
          &KARModPackManager::OpenResourcePackDir);
  connect(m_refresh_button, &QPushButton::clicked, this, &KARModPackManager::Refresh);
  connect(m_change_button, &QPushButton::clicked, this, &KARModPackManager::Change);
  connect(m_remove_button, &QPushButton::clicked, this, &KARModPackManager::Remove);
  connect(m_priority_up_button, &QPushButton::clicked, this, &KARModPackManager::PriorityUp);
  connect(m_priority_down_button, &QPushButton::clicked, this, &KARModPackManager::PriorityDown);

  connect(m_table_widget, &QTableWidget::itemSelectionChanged, this,
          &KARModPackManager::SelectionChanged);

  connect(m_table_widget, &QTableWidget::itemDoubleClicked, this,
          &KARModPackManager::ItemDoubleClicked);
}
...
int KARModPackManager::GetResourcePackIndex(QTableWidgetItem* item) const
{
  return m_table_widget->rowCount() - 1 - item->row();
}

void KARModPackManager::Change()
{
...
void KARModPackManager::Install()
{
  auto items = m_table_widget->selectedItems();
...
void KARModPackManager::Uninstall()
{
  auto items = m_table_widget->selectedItems();
...
void KARModPackManager::PriorityDown()
{
  auto items = m_table_widget->selectedItems();
...
void KARModPackManager::PriorityUp()
{
  auto items = m_table_widget->selectedItems();
...
void KARModPackManager::SelectionChanged()
{
  auto items = m_table_widget->selectedItems();
...
void KARModPackManager::ItemDoubleClicked(QTableWidgetItem* item)
{

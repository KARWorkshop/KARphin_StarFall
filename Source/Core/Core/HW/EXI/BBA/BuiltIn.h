...
//based on the Mario Party Dolphin fork, but modified to use Steam Game Networking sockets for connection
//MPN Dolphin: https://github.com/MarioPartyNetplay/Dolphin-MPN/blob/master/Source/Core/Core/HW/EXI/EXI_DeviceEthernet.h
